...
- generated_at: 2026-05-21T02:40:16.486587+00:00
...
- [x] summary view returns transport, capabilities, running, latest
  - evidence: {"capabilities": {"checks": [{"detail": "Sample photo loaded: B92DFA3B-1CD5-48E8-93B1-E13F965E2D86", "hint": "", "key": "photos_read", "status": "ok", "summary": "Apple Photos library is readable.", "title": "Photos Library Read"}, {"det...
- [x] checks view returns preflight entries
  - evidence: {"capabilities": {"checks": [{"detail": "Sample photo loaded: B92DFA3B-1CD5-48E8-93B1-E13F965E2D86", "hint": "", "key": "photos_read", "status": "ok", "summary": "Apple Photos library is readable.", "title": "Photos Library Read"}, {"det...
- [x] running view returns running/latest shape
  - evidence: {"latest": {"request_kind": "", "run_id": "", "status": "idle"}, "running": {"active": false, "count": 0, "current_run_id": ""}, "status": "ok"}
- [x] latest view returns latest shape
  - evidence: {"latest": {"request_kind": "", "run_id": "", "status": "idle"}, "status": "ok"}

## photos_library

- [x] list action returns items with source aliases
  - evidence: {"action": "list", "analyze_ready_count": 1, "count": 20, "download_required_count": 19, "items": [{"albums": ["윤지사진들"], "analyze_recommended": false, "date_taken": "2024-08-24T01:09:19+00:00", "download_hint": "Open the asset in Photos ...
- [x] apple list excludes video assets from candidates
  - evidence: [{"albums": ["윤지사진들"], "analyze_recommended": false, "date_taken": "2024-08-24T01:09:19+00:00", "download_hint": "Open the asset in Photos and wait for the original to download locally, then rerun photos_library and confirm local_path_av...
- [x] ready_only keeps only analyze-ready items
  - note: partial when no analyze-ready items are currently available
  - evidence: {"action": "ready_only", "analyze_ready_count": 1, "count": 1, "download_required_count": 0, "items": [{"albums": [], "analyze_recommended": true, "date_taken": "2025-06-30T12:18:22.852000+09:00", "filename": "E5F1F8D0-4AE2-409C-A254-AC0...
- [x] search action returns stable shape
  - evidence: {"action": "search", "analyze_ready_count": 1, "count": 10, "download_required_count": 9, "items": [{"albums": [], "analyze_recommended": false, "date_taken": "2024-08-03T11:44:05.078000+09:00", "download_hint": "Open the asset in Photos...
- [x] inspect action returns metadata/thumbnail shape
  - evidence: {"action": "inspect", "item": {"metadata": {"albums": [], "camera_make": "Apple", "camera_model": "iPhone 14 Pro Max", "date_taken": "2025-06-30T12:18:22.852000+09:00", "exposure_time": "", "filename": "E5F1F8D0-4AE2-409C-A254-AC073415D5...
...
- [x] local analyze succeeds immediately
  - evidence: {"intent": "analyze", "job_id": "analyze-20260521023934076706", "photo_id": "E5F1F8D0-4AE2-409C-A254-AC073415D571", "request_kind": "photos_run", "result": {"event": {"confidence": 0.9, "event_type": "meal"}, "faces": [], "quality": {"ae...
- [x] non-local analyze without wait returns structured blocked payload
  - evidence: {"can_retry": true, "detail": "Photo metadata was readable, but thumbnail export returned no bytes. filename=B92DFA3B-1CD5-48E8-93B1-E13F965E2D86.JPG date_taken=2024-08-24T01:09:19+00:00 current_photo_local_path_available=false runtime_p...
...
- [x] synthetic wait run can time out with structured failure
  ...
  - evidence: {"action": "summary", "can_retry": true, "detail": "Photo metadata was readable, but thumbnail export returned no bytes. filename=B92DFA3B-1CD5-48E8-93B1-E13F965E2D86.JPG date_taken=2024-08-24T01:09:19+00:00 current_photo_local_path_avai...
- [x] background workflow intents are covered when explicitly enabled
  ...
  - evidence: {"classify": {"finished_at": "", "intent": "classify", "job_id": "97adc511", "request_kind": "photos_run", "result_available": false, "run_id": "97adc511", "status": "pending", "summary_available": false, "terminal": false}, "classify_su...
...
- [x] synthetic wait result stays unavailable before terminal completion
  ...
  - evidence: {"action": "result", "finished_at": "", "request_kind": "photos_result", "result_available": false, "run_id": "analyze-20260521023953362455", "status": "running", "summary_available": true, "terminal": false}
...
- [x] vendor-run result actions are available when workflow validation is enabled
  - evidence: {"artifacts": {"action": "artifacts", "preview_path": "/Users/byoungyoungla/.photos-mcp/runtime/photo-ranker/artifacts/97adc511/previews/f225199301a51ad7a41d.jpg", "run_id": "97adc511", "selected_count": 0}, "result": {"action": "result"...
